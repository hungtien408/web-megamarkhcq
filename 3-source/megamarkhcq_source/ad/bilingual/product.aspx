            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProductNameEn" HeaderText="Tiêu Đề (En)" SortExpression="ProductNameEn"
                        Visible="False" />
                    <asp:GridBoundColumn DataField="Tag" HeaderText="Mã sản phẩm" SortExpression="Tag" Visible="false" />
                    ...
                    <asp:GridBoundColumn DataField="ProductMaterialName" HeaderText="Chất Liệu" SortExpression="ProductMaterialName" Visible="false"/>
                    <asp:GridBoundColumn DataField="ProductStyleName" HeaderText="Kiểu Dáng" SortExpression="ProductStyleName" Visible="false"/>
                    ...
                    <asp:GridTemplateColumn DataField="IsBestSeller" HeaderText="Mua nhiều" SortExpression="IsBestSeller" Visible="false">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="IsPopular" HeaderText="Ưa chuộng" SortExpression="IsPopular" Visible="false">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="9%">
                        <ItemTemplate>
                            ...
                            <img alt="Tin Tức Sản Phẩm" width="24" title="Tin Tức Sản Phẩm" src="../assets/images/articlex64.png"
                                    onclick="openWindow('productnew.aspx?PI=<%# Eval("ProductID") %>','Tin Tức Sản Phẩm')"
                                    style="cursor: pointer" />
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 255px x 265px)</span>
                                                    ...
                                                    <tr>
                                                        <td class="left" colspan="2">
                                                            ...
                                                            <asp:CheckBox ID="chkIsPopular" runat="server" CssClass="checkbox" Text=" Ưa chuộng"
                                                                Checked='<%# (Container is GridEditFormInsertItem) ? false : Eval("IsPopular") %>' Visible="false"/>
                                                            &nbsp;&nbsp;
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    ...
                                                    <span class="required">(Kích thước 800px x 820px)</span>
