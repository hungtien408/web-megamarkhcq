<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/inside.master" AutoEventWireup="true"
    CodeFile="productnew.aspx.cs" Inherits="ad_single_article" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Tin Tức Sản Phẩm</h3>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ArticleSelectAll2"
        TypeName="TLLib.Article" DeleteMethod="ArticleDelete" UpdateMethod="ArticleUpdate2"
        InsertMethod="ArticleInsert2">
        <DeleteParameters>
