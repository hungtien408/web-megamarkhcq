...
public partial class ad_single_article : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            {
                strImageName = oArticle.ArticleInsert2(
                strImageName,
                strMetaTittle,
	            strMetaDescription,
                strArticleTitle,
                ...
                if (!string.IsNullOrEmpty(strImageName))
                {
                    ...
                    ResizeCropImage.ResizeByCondition(strFullPath, 123, 86);
            ...
            else
            {
                ...
                dsUpdateParam["ProductID"].DefaultValue = Request.QueryString["PI"].ToString();
