<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="guide.aspx.cs" Inherits="ad_single_product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                            ...
                            <table width="100%">
                                <tr>
                                    <td valign="top">
                                        <div class="sub_box">
                                            <div class="head">
                                                Thông Tin Hướng Dẫn Mua Online
                                            </div>
                                            <div class="cont">
                                                ...
                                                <table class="search">
                                                    <tr class="invisible">
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 123px x 86px)</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtProductName" runat="server" Text='<%# Bind("ProductName") %>'
                                                                Width="500px" EmptyMessage="Bộ phận...">
                                                            </asp:RadTextBox>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchPriceTo" Name="PriceTo" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter DefaultValue="11" ControlID="ddlSearchCategory" Name="CategoryID" PropertyName="SelectedValue"
                Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ProductCategorySelectAll"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="11" Name="parentID" Type="Int32" />
