...
public class ShoppingCart
{
        ...
        )
    {
        ...
        if (sessionCart == null)
        {
            ...
            dtCart.Rows.Add(new object[] { ProductID, ImageName, ProductName, ProductNameEn, ProductCode, ProductOrigin, ProductPrice, ProductSavePrice,ProductOtherPrice, Quantity, Description });
        }
        else
        {
