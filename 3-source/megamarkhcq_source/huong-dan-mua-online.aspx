<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="huong-dan-mua-online.aspx.cs" Inherits="gioi_thieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:ObjectDataSource ID="odsGioiThieu" runat="server" SelectMethod="ProductSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:Parameter DefaultValue="11" Name="CategoryID" Type="String" />
