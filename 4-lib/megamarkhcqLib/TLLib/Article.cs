...
namespace TLLib
{
    public class Article
    {
        ...
        )
        {
            ...
            {
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_Article_Insert2", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@ImageName", string.IsNullOrEmpty(ImageName) ? dbNULL : (object)ImageName);
                cmd.Parameters.AddWithValue("@MetaTittle", string.IsNullOrEmpty(MetaTittle) ? dbNULL : (object)MetaTittle);
                cmd.Parameters.AddWithValue("@MetaDescription", string.IsNullOrEmpty(MetaDescription) ? dbNULL : (object)MetaDescription);
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_Article_Insert2' reported the ErrorCode : " + errorCodeParam.Value.ToString());
        ...
        )
        {
            ...
            {
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_Article_Update2", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@ArticleID", string.IsNullOrEmpty(ArticleID) ? dbNULL : (object)ArticleID);
                cmd.Parameters.AddWithValue("@MetaTittle", string.IsNullOrEmpty(MetaTittle) ? dbNULL : (object)MetaTittle);
                cmd.Parameters.AddWithValue("@MetaDescription", string.IsNullOrEmpty(MetaDescription) ? dbNULL : (object)MetaDescription);
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_Article_Update2' reported the ErrorCode : " + errorCodeParam.Value.ToString());
        ...
        public DataTable ArticleSelectAll2(
            string StartRowIndex,
            string EndRowIndex,
            string Keyword,
            string ArticleTitle,
        ...
        )
        {
            try
            {
                var dt = new DataTable();
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_Article_SelectAll2", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_Article_SelectAll2' reported the ErrorCode : " + errorCodeParam.Value.ToString());
